...
<section id="breadcrumbs" class="breadcrumbs">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <h2>Refuser la Réservation de <strong>{{ $reservation->equipement->nom }}</strong> pour <strong>{{ $reservation->nom }} {{ $reservation->prenom }}</strong></h2>
            <ol>
                ...
                <div class="card-body">
                    <form action="{{ route('reservations.reject', $reservation->id) }}" method="POST">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <button type="submit" class="btn btn-outline-danger">Rejeter la réservation</button>
